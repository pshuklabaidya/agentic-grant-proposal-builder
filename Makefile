.RECIPEPREFIX := >
.PHONY: install lint test eval version audit health health smoke check run clean status
...
check: lint test eval version audit version audit health health health smoke
